...
\noindent\rule{\textwidth}{0.6pt}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item \textit{Ưu điểm:} Tương đối đơn giản, không yêu cầu khối lượng dữ liệu lớn và chi phí tính toán thấp. 
			\item \textit{Hạn chế:} Thiếu tính chân thực trong kết quả, đặc biệt khi xử lý vùng che khuất lớn hoặc có kết cấu phức tạp; khả năng khôi phục chi tiết hạn chế.
		\end{itemize}
		...
		\begin{itemize}
			\item \textit{Ưu điểm:} Hoạt động tốt trên tập dữ liệu nhỏ, yêu cầu tài nguyên tính toán thấp.
			\item \textit{Hạn chế:} Phụ thuộc mạnh vào chất lượng đặc trưng trích xuất; khó tái tạo chi tiết phức tạp và không thể đạt tính chân thực ở mức thị giác cao.
		\end{itemize}
		...
		\begin{itemize}
			\item \textit{Ưu điểm:} Khả năng tái tạo hình ảnh tự nhiên, bảo toàn cấu trúc khuôn mặt và cải thiện tính thẩm mỹ.
			\item \textit{Hạn chế:} Yêu cầu khối lượng dữ liệu lớn và tài nguyên tính toán đáng kể; mô hình dễ xuất hiện các lỗi như nhiễu hoặc mất cân bằng màu sắc nếu không được huấn luyện cẩn thận.
		\end{itemize}
