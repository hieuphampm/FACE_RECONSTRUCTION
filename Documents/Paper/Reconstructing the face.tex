...
\begin{document}
	...
	Hình \ref{fig:result} minh họa một trường hợp thử nghiệm cụ thể.  
	Ảnh gốc (\textit{origin}) bị che khuất bởi mặt nạ (\textit{mask}), trong đó một phần khuôn mặt quan trọng (mắt) bị ẩn đi.  
	Sau khi áp dụng mô hình LaMa, chúng tôi thu được ảnh \textit{inpainted}, tuy nhiên chi tiết khuôn mặt vẫn còn mờ và chưa tự nhiên.  
	Bước cuối cùng, GFP-GAN được sử dụng để tăng cường và khôi phục chi tiết, cho kết quả \textit{restored} với hình dạng khuôn mặt hoàn chỉnh, đường nét mượt mà và các đặc trưng (mắt, miệng) rõ ràng hơn.  
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.19\textwidth]{Images/origin.png}
		\includegraphics[width=0.19\textwidth]{Images/face_mask.png}
		\includegraphics[width=0.19\textwidth]{Images/mask.png}
		\includegraphics[width=0.19\textwidth]{Images/inpaint.png}
		\includegraphics[width=0.19\textwidth]{Images/restored.png}
		\caption{Quy trình phục hồi khuôn mặt (từ trái sang phải):
			ảnh gốc, mặt nạ che vùng mắt, mặt nạ nhị phân, kết quả inpainting từ LaMa
			và ảnh phục hồi chi tiết bằng GFP-GAN.}
		\label{fig:result}
	\end{figure}
	...
	\begin{itemize}
		...
		\item \textbf{LaMa} cho phép tái tạo vùng mất mát một cách hợp lý về cấu trúc toàn cục nhờ việc khai thác \textit{Fast Fourier Convolution}, vốn có khả năng mở rộng trường tiếp nhận (receptive field) ngay từ những tầng đầu tiên \cite{lama}.
		\item \textbf{GFP-GAN} bổ sung chi tiết khuôn mặt sắc nét và giữ được tính đồng nhất về màu sắc cũng như danh tính khuôn mặt, nhờ việc sử dụng \textit{Generative Facial Prior} kết hợp với các hàm mất mát đặc thù (perceptual, identity, component loss) \cite{gfpgan}.  
	\end{itemize}
	
	Tổng thể, kết quả thử nghiệm khẳng định pipeline kết hợp này không chỉ tái tạo được cấu trúc bị che khuất, mà còn phục hồi được chi tiết khuôn mặt với độ trung thực cao. Phương pháp này có tiềm năng áp dụng trong các bài toán phục hồi ảnh chân dung, ảnh lịch sử hoặc ảnh bị hỏng do che khuất.
